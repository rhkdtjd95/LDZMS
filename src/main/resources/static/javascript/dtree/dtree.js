...
function dTree(objName) {
	...
	this.icon = {
//		root				: '/javascript/dtree/img/base.gif',		root				: '/javascript/dtree/img/database_refresh.png',			
		folder			: '/javascript/dtree/img/folder.gif',
		folderOpen	: '/javascript/dtree/img/folderopen.gif',
		node				: '/javascript/dtree/img/page.gif',
