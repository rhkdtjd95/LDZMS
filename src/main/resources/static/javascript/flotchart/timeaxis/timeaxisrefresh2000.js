...
function refreshType0100(data){
    ...
    var refreshId0100 = setInterval(function() {
        $.ajax({
            url: 'realTimeAxisType0100.action',
            type: 'POST',
            dataType: 'json',
            timeout: 4000,
...
function refreshType0300(data){
    ...
    var refreshId0300 = setInterval(function() {
        $.ajax({
            url: 'realTimeAxisType0300.action',
            type: 'POST',
            dataType: 'json',
            timeout: 4000,
            success: type0300
...
function refreshType0400(data){
    ...
    var refreshId0400 = setInterval(function() {
        $.ajax({
            url: 'realTimeAxisType0400.action',
            type: 'POST',
            dataType: 'json',
            timeout: 4000,
            success: type0400
...
function refreshType0500(data){
    ...
    var refreshId0500 = setInterval(function() {
        $.ajax({
            url: 'realTimeAxisType0500.action',
            type: 'POST',
            dataType: 'json',
            timeout: 4000,
            success: type0500
...
function refreshType0700(data){
    ...
    var refreshId0700 = setInterval(function() {
        $.ajax({
            url: 'realTimeAxisType0700.action',
            type: 'POST',
            dataType: 'json',
            timeout: 4000,
            success: type0700
...
function refreshType0800(data){
	...
	type0800(data);
	 var refreshId0500 = setInterval(function() {
         $.ajax({
             url: 'realTimeAxisType0800.action',
             type: 'POST',
             dataType: 'json',
             timeout: 4000,
             success: type0800
